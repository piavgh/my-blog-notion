      ...
      return (
        <div>
          <iframe
            ...
            src={`https://codepen.io/hoangtrinhj/embed/preview/${codePenEmbedKey}?default-tab=result`}
            frameBorder="no"
            loading="lazy"
            allowFullScreen={true}
          >
            See the Pen <a href={value.url}>Postage from Bag End</a> by Hoang
            Coyer (<a href="https://codepen.io/hoangtrinhj">@hoangtrinhj</a>) on{' '}
